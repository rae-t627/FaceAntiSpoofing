...
real_folder = 'C:\Users\Kartik\OneDrive - IIT Hyderabad\Desktop\Acad_IITH(6th Sem)\IVP\Dataset\lcc_fasd_cropped\LCC_FASD\LCC_FASD_evaluation\';
...
for i = 1:numel(subFolders)
    ...
    real_files = dir(fullfile(currentFolder, '*.png'));
...
writematrix(niqe_arr, 'niqe_test_lcc.csv');